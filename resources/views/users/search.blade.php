                                ...
                                <li class="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow">
                                    <a href="{{ route('users.show', ['user' => $user->id]) }}" class="flex flex-1 flex-col p-8">
                                        ...
                                        <dl class="mt-1 flex flex-grow flex-col justify-between">
                                            ...
                                            <dd class="text-sm text-gray-500">{{ Str::limit($user->description, 50, '...') }}</dd>
                                    ...
                                    <div>
                                        <div class="-mt-px flex divide-x divide-gray-200">
                                            <div class="flex w-0 flex-1">
                                                <a href="{{ $user->email }}" class="relative -mr-px inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-bl-lg border border-transparent py-4 text-sm font-semibold text-gray-900">
